...
wb.menu({
    ...
    "blocks": [
        ...
        {
            "blocktype": "step",
            "id": "f2ffc7ec-f201-4f89-8340-41b971dc2931",
            "help" :"bounce off of another sprite",
            "script": "(function(sprite1, sprite2){if(sprite1.collides(sprite2)){ } });",
            "sockets": [
                {
                    "name": "bounce",
                    "type": "sprite"
        ...
        },
        {
            ...
            "script": "(function(sprite){if(sprite.x < 0){sprite.x = 0;sprite.dx=0;sprite.dy=0;}else if ((sprite.x + sprite.w) > global.stage_width){sprite.x = (global.stage_width - sprite.w);sprite.dx=0;sprite.dy=0;};if(sprite.y < 0){sprite.y = 0;sprite.dy=0;sprite.dx=0;}else if((sprite.y + sprite.h) > global.stage_height){sprite.y = (global.stage_height - sprite.h);sprite.dy=0;sprite.dx=0;}})({{1}});",
            "sockets": [
                {
                    "name": "stop sprite ",
                    "type": "sprite"
        ...
        },
        {
            ...
            "script": "(function(sprite){if(sprite.x < 0){sprite.x = 0;sprite.dx=0;}else if ((sprite.x + sprite.w) > global.stage_width){sprite.x = (global.stage_width - sprite.w);sprite.dx=0;};if(sprite.y < 0){sprite.y = 0;sprite.dy=0;}else if((sprite.y + sprite.h) > global.stage_height){sprite.y = (global.stage_height - sprite.h);sprite.dy=0;}})({{1}});",
            "sockets": [
                {
                    "name": "slide sprite ",
                    "type": "sprite"
