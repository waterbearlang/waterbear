...
/*begin languages/python/python.js*/
/*
 *    PYTHON PLUGIN
 *
 *    Support for writing PYTHON using Waterbear
...
wb.prettyScript = function(elements){
    ...
    var code = before+script+after;
    
    var REdonothing = new RegExp("\\/\\* do nothing \\*\\/","g");
    code = code.replace(REdonothing, "#do nothing\n");
    
    var codesections = code.split("\n");
    var indent = 0;
    var pad = "";
            
    var indented = codesections.map(function(section){
            var newsection = section;
            if(section.length > 1 && section.charAt(0) === "\t")
            {
                indent ++;
                pad = pad + "  ";
                newsection =  newsection.substring(1, newsection.length);
            }
            
            newsection = pad + newsection;
            var lastchar = newsection.charAt(newsection.length-1);
                      
            if(newsection.charAt(newsection.length-1) === "\t")
            {
                indent --;
                pad =  pad.substring(2, pad.length);
...
/*end languages/python/python.js*/
    ...
    "blocks": [
        {
            ...
            "id": "2739b8c7-9a43-4f2b-929c-d6cfed20e38d",
            "script": "[[1]]",
        ...
        {
            "blocktype": "context",
            "id": "526aa33e-c979-42af-bb8a-c87f18ccf22b",
            "script": "if {{1}}:\n\t[[1]]\t\n",
        ...
        {
            "blocktype": "context",
            "id": "98714a9f-3cbc-42e0-b0f7-6ce8e3f0bf9d",
            "script": "if not ({{1}}):\n\t[[1]]\t\n",
        ...
        {
            "blocktype": "context",
            "id": "6aa3953c-bc0f-455f-b2bd-0ab262fefac4",
            "script": "while not ({{1}}):\n\t[[1]]\t\n",
        ...
        {
            "blocktype": "context",
            "id": "6db74c0d-dc5a-443f-b47a-3b5066be75ec",
            "locals": [
                {
        ...
        {
            "blocktype": "context",
            "id": "2ead473d-0723-4529-ad89-d3b3ec3993ed",
            "locals": [
                {
                    "blocktype": "expression",
                    "sockets": [
        ...
        {
            "blocktype": "step",
            "id": "3b724f00-3b9a-4df0-a889-491107889a16",
            "script": "variable## = {{1}};",
            "locals": [
                {
                    "blocktype": "expression",
        ...
        {
            "blocktype": "step",
            "id": "10b7bd6e-7d04-4e5f-bd21-00f60de19097",
            "script": "{{1}} = {{2}};",
            "help": "first argument must be a variable",
            "sockets": [
                {
                    "name": "NOT READY Set variable",
                    "type": "any",
                    "value": null
                },
                {
        ...
        {
            "blocktype": "context",
            "id": "6633943b-baf7-4e33-84b6-4a28338bd0a5",
        ...
        {
            "blocktype": "context",
            "id": "49e47c07-94fa-4638-8bac-55d73b1f691a",
        ...
        {
            "blocktype": "context",
            "id": "5207128e-ad6c-41d1-9fbd-cc8355dcedc9",
            "script": "while {{1}}:\n\t[[1]]\t\n",
