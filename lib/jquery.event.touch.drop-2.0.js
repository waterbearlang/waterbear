...
;(function($){ // secure $ jQuery alias
    ...
    var startevent, endevent, moveevent;
...
drop = $.event.special.drop = {
	...
	modes: { // fn scope: "$.event.special.drop" object 
		...
		'intersectBlock': function(event, proxy, target){
		    return this.modes.overlap.apply(this, [event, event.srcElement.find('b'), target.find(i)]);
	    },
		'intersectHandle': function(event, proxy, target){
			return this.contains( target, [ event.pageX, event.pageY ] ) ? // check cursor
				1e9 : this.modes.overlap.apply( this, [event, event.srcElement, target] ); // check overlap
	    },
