...
(function(wb){
    ...
    function handleStateChange(event){
        ...
        if (wb.queryParams.view === 'result'){
            ...
            wb.view = 'result';
        }else if(wb.queryParams.view === 'compare'){
            ...
            wb.toggleState.scripts_text_view = false;
            wb.view = 'compare';
        }else{
            document.body.classList.remove('compare');
            document.body.classList.remove('result');
        ...
        // }
        if (wb.view === 'compare'){
            wb.loadScriptsFromFilesystem(event, true);
        }else{
    ...
    Event.on('.compare_script', 'click', null, function(event){
        wb.historySwitchState('compare');
    });
