...
(function() {
    ...
    window.WBSearch = document.registerElement('wb-search', {
    ...
    window.WBAccordion = document.registerElement('wb-accordion', {
    ...
    */
    ...
    window.WBHBox = document.registerElement('wb-hbox', {
        prototype: HBoxProto
    });

    var VBoxProto = Object.create(HTMLElement.prototype);
    window.WBVBox = document.registerElement('wb-vbox', {
        prototype: VBoxProto
    });
